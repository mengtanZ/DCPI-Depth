...
python train.py --dataset ddad --split ddad --data_path $DATA_PATH --model_name dcpi-ddad --model lite-mono --mypretrain $PRETRAIN --version v2 --num_epochs 90 --batch_size 6 --psedo_depth psedo_depth

DATA_PATH=/remote-home/mtzhang/dataset/kitti/training
python train.py --dataset kitti --split eigen_zhou --data_path $DATA_PATH --model_name dcpi-kitti --model lite-mono-8m --mypretrain $PRETRAIN_8M --version v2 --num_epochs 30 --batch_size 12 --width 640  --height 192 --psedo_depth psedo_depth
